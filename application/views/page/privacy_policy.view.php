    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <p class="text-muted">This privacy policy has been compiled to better serve those who are concerned with how their 'Personally
                ...
                <p class="text-muted">We do not collect information from visitors of our site.</p>
                <p class="text-muted">or other details to help you with your experience.</p>
                <h4>When do we collect information?</h4>
                <p class="text-muted">We collect information from you when you register on our site or enter information on our site.</p>
                <h4>How do we use your information?</h4>
                <p class="text-muted">We may use the information we collect from you when you register, make a purchase, sign up for our newsletter,
                    respond to a survey or marketing communication, surf the website, or use certain other site features in the
                    following ways:
                </p>
                <p class="text-muted"><strong>•</strong>&nbsp;To personalize your experience and to allow us to deliver the type of content and product
                    offerings in which you are most interested.
                </p>
                <h4>How do we protect your information?</h4>
                <p class="text-muted">We do not use vulnerability scanning and/or scanning to PCI standards.</p>
                <p class="text-muted">We only provide articles and information. We never ask for credit card numbers.</p>
                <p class="text-muted">We do not use Malware Scanning.</p>
                <p class="text-muted">We do not use an SSL certificate</p>
                <p class="text-muted"><strong>•</strong>&nbsp;We only provide articles and information. We never ask for personal or private
                    information like names, email addresses, or credit card numbers.
                </p>
                <h4>Do we use 'cookies'?</h4>
                <p class="text-muted">Yes. Cookies are small files that a site or its service provider transfers to your computer's hard drive through
                ...
                <p class="text-muted"><strong>•</strong>&nbsp;Keep track of advertisements.</p>
                <p class="text-muted">You can choose to have your computer warn you each time a cookie is being sent, or you can choose to turn off all
                ...
                <p class="text-muted">If you turn cookies off, some features will be disabled. It won't affect the user's experience that make your
                    site experience more efficient and may not function properly.
                </p>
                <p class="text-muted">However, you will still be able to place orders .</p>
                <h4>Third-party disclosure</h4>
                <p class="text-muted">We do not sell, trade, or otherwise transfer to outside parties your Personally Identifiable Information unless
                ...
                <p class="text-muted">However, non-personally identifiable visitor information may be provided to other parties for marketing,
                    advertising, or other uses.
                </p>
                <h4>Third-party links</h4>
                <p class="text-muted">Occasionally, at our discretion, we may include or offer third-party products or services on our website. These
                ...
                <h4>Google</h4>
                <p class="text-muted">Google's advertising requirements can be summed up by Google's Advertising Principles. They are put in place to
                    provide a positive experience for users. <a href="https://support.google.com/adwordspolicy/answer/1316548?hl=en">See
                        here</a>
                </p>
                <p class="text-muted">We use Google AdSense Advertising on our website.</p>
                <p class="text-muted">Google, as a third-party vendor, uses cookies to serve ads on our site. Google's use of the DART cookie enables
                ...
                <p class="text-muted"><strong>•</strong>&nbsp;Remarketing with Google AdSense</p>
                <p class="text-muted"><strong>•</strong>&nbsp;Google Display Network Impression Reporting</p>
                <p class="text-muted"><strong>•</strong>&nbsp;Demographics and Interests Reporting</p>
                <p class="text-muted"><strong>•</strong>&nbsp;DoubleClick Platform Integration</p>
                <p class="text-muted">We, along with third-party vendors such as Google use first-party cookies (such as the Google Analytics cookies)
                ...
                <h4>Opting out:</h4>
                <p class="text-muted">Users can set preferences for how Google advertises to you using the Google Ad Settings page. Alternatively, you
                ...
                <p class="text-muted">CalOPPA is the first state law in the nation to require commercial websites and online services to post a privacy
                    ...
                    collected and those individuals or companies with whom it is being shared. - <a href="http://consumercal.org/california-online-privacy-protection-act-caloppa/#sthash.0FdRbT51.dpuf">See
                        more</a>
                </p>
                <h4>According to CalOPPA, we agree to the following:</h4>
                <p class="text-muted">Users can visit our site anonymously.</p>
                <p class="text-muted">Once this privacy policy is created, we will add a link to it on our home page or as a minimum, on the first
                    significant page after entering our website.
                </p>
                <p class="text-muted">Our Privacy Policy link includes the word 'Privacy' and can be easily be found on the page specified above.</p>
                <h4>You will be notified of any Privacy Policy changes:</h4>
                <p class="text-muted">• On our Privacy Policy Page</p>
                <h4>Can change your personal information:</h4>
                <p class="text-muted"><strong>•</strong> By logging in to your account</p>
                <h4>How does our site handle Do Not Track signals?</h4>
                <p class="text-muted">We honor Do Not Track signals and Do Not Track, plant cookies, or use advertising when a Do Not Track (DNT)
                ...
                <p class="text-muted">When it comes to the collection of personal information from children under the age of 13 years old, the
                ...
                <p class="text-muted">We do not specifically market to children under the age of 13 years old.</p>
                <h4>Fair Information Practices</h4>
                <p class="text-muted">The Fair Information Practices Principles form the backbone of privacy law in the United States and the concepts
                ...
                <p class="text-muted">We will notify you via email within 7 business days</p>
