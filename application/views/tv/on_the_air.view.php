<div class="jumbo-hero" style="background-image:url(<?= BASE_PATH ?>/public/images/bg.jpg)">
    <div class="container">
        <div class="jumbo-hero__inner">
            <h1 class="header">On The Air TV <?php echo $data['pages']; ?></h1>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-12 text-center pagenate">
                <ul class="pagination" role="navigation">
                    ...
                    <?php else : ?>
                        <li class="page-item">
                            <a class="page-link" href="<?= URL_WEBSITE ?>/tv/on_the_air/<?= $data['page'] - 1; ?>" rel="next">&lsaquo; Prev</a>
                        </li>
                    <?php endif; ?>


                    <li class="page-item">
                        <a class="page-link" href="<?= URL_WEBSITE ?>/tv/on_the_air/<?= $data['page'] + 1; ?>" rel="next">Next &rsaquo;</a>
                    </li>
                </ul>
