            ...
            <div class="row">
                <div class="col-12 text-center pagenate">
                    <ul class="pagination" role="navigation">
                        ...
                        <?php else : ?>
                            <li class="page-item">
                                <a class="page-link" href="<?= URL_WEBSITE ?>/search/movies/<?= $data['page'] - 1; ?>?s=<?= $_GET['s']; ?>" rel="next">&lsaquo; Prev</a>
                            </li>
                        <?php endif; ?>

                        <li class="page-item">
                            <a class="page-link" href="<?= URL_WEBSITE ?>/search/movies/<?= $data['page'] + 1; ?>?s=<?= $_GET['s']; ?>" rel="next">Next &rsaquo;</a>
                        </li>
                    </ul>
                </div>
            </div>
