...
<form action="<?= URL_WEBSITE; ?>/admin/builder/store" enctype="multipart/form-data" method="post">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="mb-3">
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <select name="btn_type" id="btn_type" class="form-control">
            ...
            <div class="mb-3">
                <label for="custom_css" class="form-label">Kustom CSS</label>
            ...
            <div class="mb-3">
                <label for="script_locker" class="form-label">Script Locker</label>
